...
$("form").submit(function() {
	...
	$('#upload_target').unbind().load( function(){
		...
		/** lines added by Michael Orji, to enable us use any form for uploading rather than the form that came with the original app */
		var bigImgView = document.createElement("div");
		bigImgView.id = "div_upload_big";
		document.getElementById('upload_thumb').parentNode.insertBefore( bigImgView, document.getElementById('upload_thumb') );
		/** end of lines added by Michael Orji */

...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	*/
	...
	(
	  array
	  (
	  'file_field_name'=>'photo', 'temp_directory'=>$upl_dir.'/temp/', 'upload_dir'=>$upl_dir, 'final_filename'=>$fname, 'file_extension'=>$file_extension, 
...
<body>
 <form id="upload_form" method="post" enctype="multipart/form-data" action="<?php echo $action_page; ?>" target="dummy">
  <label for="photo"><h3>1. Upload An Image :</h3></label>
  <input name="photo" size="27" type="file" />              
 ...
 array('form_id'=>'upload_form', 'action_page'=>$action_page, 'include_thumb_scale_details'=>true, 'iframe_id'=>'', 'iframe_name'=>'') 
 ); 
 ?>
</body>
</html>